...
Partial Class m_project
   ...
   Public BC AS NEW MProjectBC
    ...
    Protected Sub btnUpdate_Click(sender As Object, e As System.EventArgs) Handles btnUpdate.Click
            ...
            Try
            BC.UpdMProject(hidProjectId.Text, hidLineId.Text, tbxProjectId.Text, tbxLineId.Text, tbxProjectName.Text, ViewState("menu_user_cd"))
        MsInit()
...
Me.hidOldRowIdx.Text = ""
    ...
    Protected Sub btnInsert_Click(sender As Object, e As System.EventArgs) Handles btnInsert.Click
        ...
        'データ存在チェック
            ...
            End If
            Try
            BC.InsMProject(tbxProjectId.Text, tbxLineId.Text, tbxProjectName.Text, ViewState("menu_user_cd"))
                MsInit()
            Catch ex As Exception
                Common.ShowMsg(Me.Page, ex.Message)
                Exit Sub
