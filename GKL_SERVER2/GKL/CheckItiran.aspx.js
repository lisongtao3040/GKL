...
function BeSel() {
    //window.opener.document.getElementById('btnSelect').click();

    $("#hidScroll").val(document.getElementById('divGvw').scrollTop);
...
var qpBtn;
function OpenQianpin(e, url) {
    //window.open('Qianpin.aspx?chk_no=<%#Eval("chk_no")%>')
    qpBtn = e;
    window.open(url);
}