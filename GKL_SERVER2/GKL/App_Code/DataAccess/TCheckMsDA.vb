...
Public Class TCheckMsDA
    ...
    Public Function UpdTCheckMs(ByVal chkNo_key As String, _
        ...
        paramList.Add(SqlHelperNew.MakeParam("@in_1", SqlDbType.VarChar, 30, in1))
        paramList.Add(SqlHelperNew.MakeParam("@in_2", SqlDbType.VarChar, 30, in2))
    ...
    Public Function SelTCheckMs(ByVal chkNo_key As String, ByVal line_id As String) As Data.DataTable
        ...
        With sb
            ...
            .AppendLine("	    ISNULL(t_cd_temp_relation.color_nm,'') color_nm,")
            .AppendLine("	    ISNULL(t_cd_temp_relation.midcode,'') midcode,")
            .AppendLine("	    ISNULL(t_cd_temp_relation.wenlu,'') wenlu,")
            .AppendLine("	    ISNULL(t_cd_temp_relation.dh,'') dh,")
            .AppendLine("	    ISNULL(t_cd_temp_relation.dw,'') dw,")
            .AppendLine("	    ISNULL(t_cd_temp_relation.sw,'') sw,")
            .AppendLine("	    ISNULL(t_cd_temp_relation.dingfansize,'') dingfansize,")
            ...
            .AppendLine("		LEFT JOIN t_cd_temp_relation ")
            .AppendLine("			ON t_check_ms.line_id = t_cd_temp_relation.line_id")
            .AppendLine("		   AND t_check_result.code = t_cd_temp_relation.code")
            .AppendLine("		   AND t_check_result.temp_id = t_cd_temp_relation.temp_id")
