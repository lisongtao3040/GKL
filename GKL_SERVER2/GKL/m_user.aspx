    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div id="divGvwTitle" class='jq_title_div' runat="server" style="overflow: hidden; margin-left: 0px; width: 1004px; margin-top: 0px; border-collapse: collapse;">
                <table class='ms_title' style="width: 800px" cellpadding="0" cellspacing="0">
                    <tr>
                ...
                <table class='ms_input' style="width: 800px" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="width: 170px;">
                            <asp:TextBox ID="tbxUserName" placeholder="用户名汉字" class="jq_user_name_ipt" runat="server" MaxLength="10" Style="width: 100%;"></asp:TextBox>
                        </td>
                        <td style="width: 170px;">
                            <asp:TextBox ID="tbxUserPassword" placeholder="密码" class="jq_user_password_ipt" runat="server" MaxLength="10" Style="width: 100%;"></asp:TextBox>
                        </td>
                        <td style="">
                            <asp:TextBox ID="tbxKengen" placeholder="权限" class="jq_kengen_ipt" runat="server" MaxLength="1" Style="width: 100%;"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <!--明細Body部-->
            <div id="divGvw" class='jq_ms_div' runat="server" style="overflow: scroll; height: 500px; margin-left: 0px; width: 820px; margin-top: 0px; border-collapse: collapse;">

                <asp:GridView CssClass="jq_ms" Width="800px" runat="server" ID="gvMs" EnableTheming="True" ShowHeader="False" AutoGenerateColumns="False" BorderColor="black" Style="margin-top: -1px;" TabIndex="-1">
                    <Columns>
                        <asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemStyle HorizontalAlign="Left" CssClass="jq_user_password" />
                        </asp:TemplateField>
                        <asp:TemplateField>
