...
Partial Class apexcharts_Default
    ...
    Public Function GetGraData() As String
        ...
        Dim isallline As Boolean = False

        If System.Configuration.ConfigurationManager.AppSettings.Get("Chk_AllLines_lines").ToString().IndexOf(tbxLineId_key.Text.Trim) >= 0 Then
            isallline = True

        End If


        Dim dt As Data.DataTable = BC.SelTCheckResult(tbxLineId_key.Text.Trim, startDate.ToString("yyyy/MM/dd"), startEnd.ToString("yyyy/MM/dd"), "", "", isallline)
