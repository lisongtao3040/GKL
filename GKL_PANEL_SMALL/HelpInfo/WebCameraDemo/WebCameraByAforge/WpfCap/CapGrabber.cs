    ...
    internal class CapGrabber:ISampleGrabberCB,INotifyPropertyChanged
    {
        ...
        public int BufferCB(double sampleTime, IntPtr buffer, int bufferLen)
        {
            ...
            if (Map != IntPtr.Zero)
            {
                ...
                //{
                //    i = 1;
                //    byte[] streamData = new byte[bufferLen];
                //    Marshal.Copy(buffer, streamData, 0, bufferLen);
                //    MemoryStream buffer1 = new MemoryStream(streamData);
                //    Bitmap a = new Bitmap(buffer1);
                //    a.Save("abc.jpg",System.Drawing.Imaging.ImageFormat.Jpeg);
                //}
                OnNewFrameArrived();
            }
            return 0;
