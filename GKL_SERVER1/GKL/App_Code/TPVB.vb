...
Public Class TPVB
    ...
    '获得托盘LIST 便别 向先
    Public Function GetNoListByTray(ByVal tray As String) As String

        Dim model As Root2 = New Root2 With {
            .tray = tray
        }

        Dim Data = Post2(client.BaseAddress.ToString & "Tray/GetNoListByTray", model)
        If String.IsNullOrEmpty(Data) Then
            Return ""
        Else
            Return Data.ToString()
    ...
    Public Function Post(ByVal url As String, ByVal data As Root) As String
        Try
            ...
            'Return JsonConvert.SerializeObject("isSuccess:1,message:''")
            'Return JsonConvert.SerializeObject(New With {.isSuccess = 1, .message = ""})
    ...
    Public Function Post2(ByVal url As String, ByVal data As Root2) As String
        Try
