...
Public Class BGAcion
    ...
    Public pub_StartTime As String = ""
    ...
    Public Function RunBG(ByVal cd As String, ByVal no As String, ByVal lsttpNo As List(Of String), ByVal lsttp_bar_cd As List(Of String), ByVal user As String, ByVal bg_user As String, ByVal bg_type As String) As String
        ...
        SyncLock Padlock
            ...
            '新报工开始时间取得
            pub_StartTime = BaoGongDA2.GetNowByT_OrderConfirmList
            ...
            For i As Integer = 0 To lsttpNo.Count - 1
                ...
                If IsLoginRtv Then
                    ...
                    If drs.Length > 0 Then
                        ...
                        wIdx = 0
                        ' 正在执行 ， 并且小于30秒
                        While inProcessing AndAlso wIdx < 30
                            Threading.Thread.Sleep(500)
                            wIdx = wIdx + 1

                            Try
                                '新报工开始结果取得
                                Dim TORlt As String = BaoGongDA2.GetBaogongRltFromT_OrderConfirmList(no, drs(0).Item("bg_bar_data"), pub_StartTime)

                                If TORlt <> "|" Then

                                    Dim msgTxt As String = TORlt.Split("|"c)(0)
                                    Dim msgType As String = TORlt.Split("|"c)(1)
                                    ...
                                    BaoGongDA2.UpdMSData(pvCd, pvNo, pvBgno, pvBarScanNo, result, msgTxt, pvUser, pvbg_user, pvbg_type)
            ...
            If BaoGongDA2 Is Nothing Then
                BaoGongDA2 = New BaoGongDA2
            End If
