...
Public Class BaoGongDA
    ...
    Public Function UpdMSData(ByVal cd As String, ByVal no As String, ByVal tp_no As String, ByVal bg_result As String, ByVal bg_txt As String, ByVal user As String, ByVal bg_user As String _
                              , ByVal bg_type As String) As Boolean
