...
Public NotInheritable Class DataAccessManager
    ...
    Private Shared connectionBaogongStr As String =
    System.Configuration.ConfigurationManager.
    ConnectionStrings("connectionBaogong").ConnectionString
    ...
    Public Shared ReadOnly Property ConnectionBaogong() As String
        Get
            'PubInit
            'Return Pubinit.
            Return connectionBaogongStr
        End Get
    End Property
