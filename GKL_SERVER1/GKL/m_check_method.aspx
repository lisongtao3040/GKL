...
<!--条件部-->
        <table class='jyouken_panel' cellpadding="0" cellspacing="0">
            ...
            <td>检查方法ID : &nbsp;</td>
            <td>
              <asp:TextBox ID="tbxChkId_key" class="jq_chk_id_key" runat="server" style="width:200px;background-color: #FFAA00;"></asp:TextBox>
            </td>
            <td></td>
            </tr>
            <tr>
...
2:固定（合/否）*没有公式">
      ...
      <table class='ms_input' style="width:950px" cellpadding="0" cellspacing="0">
          <tr>
              ...
              <td style="">
              <asp:TextBox ID="tbxVerifyMethodExplain" class="jq_verify_method_explain_ipt" runat="server" maxLength="200" style="width:96%;"></asp:TextBox>
          </td>
          </tr>
      </table>
