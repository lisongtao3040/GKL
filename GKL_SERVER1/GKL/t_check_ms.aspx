...
<head runat="server">
    ...
    <script type="text/javascript" src="./config.js?ver=144"></script>
    <%--    <script src="js/jquery-2.1.1.js"></script>--%>
    <script language="javascript" type="text/javascript" src="./t_check_ms.aspx.js?version=22234131"></script>
    <script language="javascript" type="text/javascript" src="./t_check_msForTpAndBg.js?version=33351"></script>
    ...
    <link href="t_check_ms.aspx.css?version=2019032605001" rel="stylesheet" type="text/css" />


</head>
<body>
    <form id="form1" runat="server">
        <div id='cover' style='position: absolute; display: none; width: 100%; height: 100%; padding-top: 200px; color: blue; opacity: 0.5; left: 0px; top: 0px; z-index: 100000; background-color: #ccc; text-align: center; font-size: 60px'>
        </div>

        <div id="LR" style="display: none; position: absolute; width: 700px; height: 400px; z-index: 100000; font-size: 50px; text-align: center; vertical-align: middle; margin: 15% auto 30% auto; background-color: #fff; border: 3px solid #ccc;">
            左右选择

            <hr />
            <input type="button" id="btnLeft" value="左" style="font-size: 80px; height: 100px; width: 200px" />
            <input type="button" id="btnRight" value="右" style="font-size: 80px; height: 100px; width: 200px" />
            <input type="button" value="取消" style="font-size: 80px; height: 100px; width: 200px" onclick="$('#LR').hide()" />
        </div>


        <div class='title_div' style="width: 99%; height: 50px; line-height: 50px; vertical-align: middle;">
            <%--            <div style="float: left; border-radius: 125px; margin: 0px 0px; width: 60px; height: 60px; background-color: #fff; text-align: center; color: #000; font-size: 36px;">
                G1
            </div>--%>
            ...
            <div style="float: left; padding-left: 4px;">
                ...
                (<b id="acTp"></b>)
                <input type="button" value="修正托盘" id="editTp" style="width: 160px; height: 60px; margin-left: 10px;" />
                &nbsp;&nbsp;
                <input type="button" value="呼叫" id="btnHujiao" runat="server" style="width: 160px; height: 60px; margin-left: 10px;" />
                <asp:Button ID="btnYXLD" runat="server" Text="影像联动" Style="width: 160px; height: 60px; margin-left: 10px;" />
            ...
            <table>
                <tr>
                    ...
                    <th style="width: 130px;">
                        <button class="close_btn" style="margin-top: 5px; width: 120px;" onclick="$('#hujiao').hide();return false">关闭</button></th>
                    <th id="" class="qr_th">台车
                    </th>
                </tr>
                <tr>
                    <td id="tdStation" class="qr_td" style="text-align: left;"></td>
                    <td>&nbsp</td>
                    <td id="tdTaiChe" class="qr_td" style="text-align: left;"></td>
                </tr>
            </table>
        ...
        <div class="NEW_TP_DIV" id="NEW_TP_DIV">
            ...
            <table>
                ...
                <tr>
                    <td>1：</td>
                    <td class="defaultTpTd" id="defaultTpTd1"></td>
                    <td>
                        <input type='text' typ="scan" class='tp_barcode' idx="1" id='iptTpBarcode1' value='' /></td>
                    <td><a id="xiangxian1" idx="1"></a></td>
                    <td>
                        <button class="tp_btn" idx="1" onclick="SetNewTpBarcode(this);return false">设定</button></td>
                    <td>
                        <button class="tp_btn" idx="1" onclick="SetTpDefault(this);return false">默认</button></td>
                    <td>
                        <button class="tp_btn" idx="1" onclick="SetTpClear(this);return false">清空</button></td>
                </tr>
                <tr>
                    <td>2：</td>
                    <td class="defaultTpTd" id="defaultTpTd2"></td>
                    <td>
                        <input type='text' typ="scan" class='tp_barcode' idx="2" id='iptTpBarcode2' value='' /></td>
                    <td><a id="xiangxian2" idx="2"></a></td>
                    <td>
                        <button class="tp_btn" idx="2" onclick="SetNewTpBarcode(this);return false">设定</button></td>
                    <td>
                        <button class="tp_btn" idx="2" onclick="SetTpDefault(this);return false">默认</button></td>
                    <td>
                        <button class="tp_btn" idx="2" onclick="SetTpClear(this);return false">清空</button></td>
                </tr>
                <tr>
                    <td>3：</td>
                    <td class="defaultTpTd" id="defaultTpTd3"></td>
                    <td>
                        <input type='text' typ="scan" class='tp_barcode' idx="3" id='iptTpBarcode3' value='' /></td>
                    <td><a id="xiangxian3" idx="3"></a></td>
                    <td>
                        <button class="tp_btn" idx="3" onclick="SetNewTpBarcode(this);return false">设定</button></td>
                    <td>
                        <button class="tp_btn" idx="3" onclick="SetTpDefault(this);return false">默认</button></td>
                    <td>
                        <button class="tp_btn" idx="3" onclick="SetTpClear(this);return false">清空</button></td>
                </tr>
                <tr>
                    <td>4：</td>
                    <td class="defaultTpTd" id="defaultTpTd4"></td>
                    <td>
                        <input type='text' typ="scan" class='tp_barcode' idx="4" id='iptTpBarcode4' value='' /></td>
                    <td><a id="xiangxian4" idx="4"></a></td>
                    <td>
                        <button class="tp_btn" idx="4" onclick="SetNewTpBarcode(this);return false">设定</button></td>
                    <td>
                        <button class="tp_btn" idx="4" onclick="SetTpDefault(this);return false">默认</button></td>
                    <td>
                        <button class="tp_btn" idx="4" onclick="SetTpClear(this);return false">清空</button></td>
                </tr>
                <tr>
                    <td>5：</td>
                    <td class="defaultTpTd" id="defaultTpTd5"></td>
                    <td>
                        <input type='text' typ="scan" class='tp_barcode' idx="5" id='iptTpBarcode5' value='' /></td>
                    <td><a id="xiangxian5" idx="5"></a></td>
                    <td>
                        <button class="tp_btn" idx="5" onclick="SetNewTpBarcode(this);return false">设定</button></td>
                    <td>
                        <button class="tp_btn" idx="5" onclick="SetTpDefault(this);return false">默认</button></td>
                    <td>
                        <button class="tp_btn" idx="5" onclick="SetTpClear(this);return false">清空</button></td>
                </tr>
                <tr>
                    <td>6：</td>
                    <td class="defaultTpTd" id="defaultTpTd6"></td>
                    <td>
                        <input type='text' typ="scan" class='tp_barcode' idx="6" id='iptTpBarcode6' value='' /></td>
                    <td><a id="xiangxian6" idx="6"></a></td>
                    <td>
                        <button class="tp_btn" idx="6" onclick="SetNewTpBarcode(this);return false">设定</button></td>
                    <td>
                        <button class="tp_btn" idx="6" onclick="SetTpDefault(this);return false">默认</button></td>
                    <td>
                        <button class="tp_btn" idx="6" onclick="SetTpClear(this);return false">清空</button></td>
                </tr>
            </table>
        ...
        <div class="baogong_panel" id="baogong_panel">
            <div class="baogong_panel_title" id="baogong_panel_title">
                ...
                <hr />
                <input type="button" value="报工" id="btnTp1" class="tp_button" />
                <input type="button" value="报工" id="btnTp2" class="tp_button" />
                <input type="button" value="报工" id="btnTp3" class="tp_button" />
                <input type="button" value="报工" id="btnTp4" class="tp_button" />
                <input type="button" value="报工" id="btnTp5" class="tp_button" />
                <input type="button" value="报工" id="btnTp6" class="tp_button" />
        ...
        <div style="width: 1040px;" class="">
            ...
            <div class="">
                    ...
                    <tr>
                        ...
                        <td class="jq_kbtd" style="width: 250px; vertical-align: top; text-align: center;">
                            ...
                            <table class="keyboard">
                                ...
                                <tr class="jq_hantei_btn kb_okng">
                                    <td colspan="2">
                                ...
                                <tr class="divYXLD">
                                    <td rowspan="1" colspan="3">
                                        <input type="button" class="" style="height: 100%" value="影像联动检查" /></td>
                                </tr>
                ...
                <div id="kameira" style="width: 1010px; z-index: 10000; top: 1px; left: 1px;">
                    ...
                    <a style="font-size: 35px;">照片一览
                        <input type="button" value="刷新" onclick="ImgsInit()" style="width: 200px" /></a>
