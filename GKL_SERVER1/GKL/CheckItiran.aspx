...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="./CheckItiran.aspx.js?version=20260811"></script>
    ...
    <form id="form1" runat="server">
        ...
        <div style="width: 1040px;">
            ...
            <div id="div1" class='jq_title_div' runat="server" style="overflow: hidden; margin-left: 0px; width: 1044px; margin-top: 0px; border-collapse: collapse;">
                <table class="ms_title" style="width: 1040px;" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="width: 110px;">检查模板编号
                        </td>
                        <td style="width: 60px;">检查结果
                        </td>
                        <td style="width: 110px;">检查者
                        </td>
                        <td style="width: 118px;"><%--预定检查日<br />--%>向先
                        </td>
                        <td style="">状态
                        </td>
                    </tr>
                ...
                <asp:GridView CssClass="jq_ms" Width="1040px" runat="server" ID="gvMs" EnableTheming="True" ShowHeader="False" AutoGenerateColumns="False" BorderColor="black" Style="margin-top: -1px;" TabIndex="-1">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemStyle Width="110px" HorizontalAlign="Center" CssClass="jq_temp_id" />
                        </asp:TemplateField>
                        <asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate><%--<%#Eval("yotei_chk_date")%><br />--%><%#Eval("xiangxian")%></ItemTemplate>
            ...
            <div style="height: 1px;">
                ...
                <asp:TextBox ID="hidScanFlg" runat="server" CssClass="" Style="visibility: hidden;"></asp:TextBox>
            ...
            <table class='jyouken_panel' cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td style="width: 200px;">
                        <asp:TextBox ID="lblUserName" CssClass="" runat="server" Style="width: 100px; background-color: #fff; color: #000; border: none;" TabIndex="-1" Enabled="false"></asp:TextBox>
                    </td>
                    <td style="width: 460px;" colspan="3">生产线 :
                ...
                <tr>
                    <td colspan="7">
                        ...
                        <div style="width: 1000px; text-align: right;">
                            ...
                            &nbsp;<asp:Button ID="btnComlete" runat="server" Text="强制完了" CssClass="" OnClick="btnComlete_Click" Enabled="false" />
                            &nbsp;
