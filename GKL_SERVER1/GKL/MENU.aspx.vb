...
Partial Class MENU
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            '    .AppendLine("   setCookie('login_user_cd','" & ViewState("menu_user_cd") & "',1);")
            '    .AppendLine("alert(2);")
            '    .AppendLine("}")
            ...
            ifm1.Attributes.Item("src") = "http://10.160.192.114/DWP20/GKL_CHK_MENU.aspx?user_id=" + ViewState("menu_user_cd") + "&user_name=" + ViewState("menu_user_name") + "&line_cd=" + ViewState("menu_line_id")

            ifm2.Attributes.Item("src") = "http://10.160.192.114/DWP20/GKL_CHK_MENU2.aspx?user_id=" + ViewState("menu_user_cd") + "&user_name=" + ViewState("menu_user_name") + "&line_cd=" + ViewState("menu_line_id")
        ...
        If IsInternetExplorer() Then
            ifm1.Visible = False
            ifm2.Visible = False

            ' 这里可以添加其他逻辑，例如重定向、隐藏某些控件等
        Else
    ...
    Private Function IsInternetExplorer() As Boolean
        ...
        Return Not String.IsNullOrEmpty(userAgent) AndAlso (userAgent.Contains("MSIE") OrElse userAgent.Contains("Trident"))
    End Function
    ...
    End Sub
    Protected Sub lbtnColorChkList_Click(sender As Object, e As EventArgs) Handles lbtnColorChkList.Click
        Server.Transfer("t_colorcheck_result.aspx")
    End Sub
End Class
